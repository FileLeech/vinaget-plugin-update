...
?>
							<form action="javascript:get(document.getElementById('linkform'));" name="linkform" id="linkform">
								...
								<?php if($obj->isadmin()){
									...
									if($obj->last_version > $obj->current_version2)
										echo '<br><font color="#dbac58"><b>'.sprintf($obj->lang['update1']).'</b> - <a href="https://github.com/lethanhtuan2897/vinaget-plugin-update">'.sprintf($obj->lang['update2'],$obj->last_version).'</a></font>'; 
								}
								?>
...
?>
				<!-- ########################## End Main ########################### -->
					...
					<!-- Copyright please don't remove-->
						<STRONG><SPAN class='powered' style="font-size: 12px;">Code LeechViet. Developed by ..:: [H] ::..<br/>Powered by <a href='http://rapidleech.com/forum/viewforum.php?f=23'><?php printf($obj->lang['version']); ?> Revision <?php printf($obj->current_version); ?></a> by [FZ]. Skin by Rhuan Gonzaga<br/>
						Unofficial code updated by [LTT]. Current version: <a target='_blank' href='https://github.com/lethanhtuan2897/vinaget-plugin-update'><?php printf($obj->current_version2); ?></a></SPAN><br/>
