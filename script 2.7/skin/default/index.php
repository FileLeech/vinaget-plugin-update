			...
			<table width="60%" align="center" cellpadding="0" cellspacing="0">
				<tr><td>
					...
					<!-- Copyright please don't remove-->
						<STRONG><SPAN class='powered'>Code LeechViet. Developed by ..:: [H] ::..<br/>Powered by <a href='http://rapidleech.com/forum/viewforum.php?f=23'><?php printf($obj->lang['version']); ?> Revision <?php printf($obj->current_version); ?></a> by [FZ]<br/>
