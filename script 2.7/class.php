...

{
	...
	function getversion(){
		$version = $this->cut_str($this->curl("https://github.com/lethanhtuan2897/vinaget-script-update.git", "", ""), '<span class="num text-emphasized">','</span>');
...
{ 
	...
	{
		$ch = @curl_init();
		if ($ref !==0) curl_setopt($ch, CURLINFO_HEADER_OUT, true);
